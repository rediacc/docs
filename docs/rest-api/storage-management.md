...
Retrieves a list of all storage resources within a team.

### Endpoint

```
POST /api/StoredProcedure/GetTeamStorages
```
      ...
      "data": [
        {
          "storageName": "Main Database",
          "vaultVersion": 2,
          "vaultContent": "{\"type\":\"postgres\",\"version\":\"15\",\"connection\":{\"host\":\"db.example.com\"},\"settings\":{...}}",
          "teamName": "Engineering Team"
        },
        {
          "storageName": "File Storage",
          "vaultVersion": 1,
          "vaultContent": "{\"type\":\"s3\",\"bucket\":\"app-files\",\"settings\":{...}}",
          "teamName": "Engineering Team"
        }
      ]
    }
