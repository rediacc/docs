...
export default function SecurityFeature() {
  return (
    <Layout
      ...
      description="Protect your infrastructure with military-grade AES-256 encryption, multi-factor authentication, real-time threat detection, and compliance-ready security features.">
      
      <Head>
        <meta property="og:title" content="Enterprise Infrastructure Security Solutions" />
        <meta property="og:description" content="Military-grade security for your infrastructure. AES-256 encryption, MFA, real-time threat detection, and complete compliance coverage." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Enterprise-grade infrastructure security with encryption, MFA, and compliance",
            "brand": {
              "@type": "Brand",
              "name": "Rediacc"
            },
          ...
          <div className="container">
            ...
            <div style={{maxWidth: '800px', margin: '0 auto', lineHeight: '1.8', fontSize: '1.1rem'}}>
              <p>
                ...
                Organizations face sophisticated attacks, stringent compliance requirements, and the 
              ...
              <div style={{margin: '2rem 0', padding: '1.5rem', background: 'var(--ifm-background-surface-color)', borderRadius: '8px'}}>
                ...
                <ul>
                  ...
                  <li><strong>Compliance Violations:</strong> GDPR fines up to 4% of global revenue</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', maxWidth: '1200px', margin: '0 auto'}}>
              <div className="feature-card" style={{textAlign: 'center'}}>
                <div style={{fontSize: '2rem', marginBottom: '0.5rem'}}><Icon name="flag" size={24} /></div>
                <h4>GDPR</h4>
                <p style={{fontSize: '0.9rem'}}>Full GDPR compliance with data residency controls</p>
              </div>
              <div className="feature-card" style={{textAlign: 'center'}}>
                <div style={{fontSize: '2rem', marginBottom: '0.5rem'}}><Icon name="healthcare" size={24} /></div>
                <h4>HIPAA</h4>
                <p style={{fontSize: '0.9rem'}}>Healthcare data protection standards</p>
              </div>
              <div className="feature-card" style={{textAlign: 'center'}}>
                <div style={{fontSize: '2rem', marginBottom: '0.5rem'}}><Icon name="credit-card" size={24} /></div>
                <h4>PCI-DSS</h4>
                <p style={{fontSize: '0.9rem'}}>Payment card industry compliance</p>
              </div>
              <div className="feature-card" style={{textAlign: 'center'}}>
                <div style={{fontSize: '2rem', marginBottom: '0.5rem'}}><Icon name="building" size={24} /></div>
                <h4>SOC 2</h4>
                <p style={{fontSize: '0.9rem'}}>Type II certified operations</p>
              </div>
              <div className="feature-card" style={{textAlign: 'center'}}>
                <div style={{fontSize: '2rem', marginBottom: '0.5rem'}}><Icon name="locked" size={24} /></div>
                <h4>ISO 27001</h4>
            ...
            <div style={{marginTop: '3rem', padding: '2rem', background: 'var(--ifm-background-color)', borderRadius: '8px', maxWidth: '800px', margin: '3rem auto 0'}}>
              ...
              <ul style={{lineHeight: '2', fontSize: '1.1rem'}}>
                <li><Icon name="success" size={16} style={{marginRight: '8px'}} /><strong>Audit Logging:</strong> Immutable audit trails for all operations</li>
                ...
                <li><Icon name="success" size={16} style={{marginRight: '8px'}} /><strong>Right to Erasure:</strong> GDPR-compliant data deletion</li>
                <li><Icon name="success" size={16} style={{marginRight: '8px'}} /><strong>Data Portability:</strong> Export data in standard formats</li>
                <li><Icon name="success" size={16} style={{marginRight: '8px'}} /><strong>Compliance Reporting:</strong> Automated compliance reports and attestations</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{padding: '4rem 1rem', background: 'var(--ifm-background-surface-color)'}}>
          <div className="container">
            ...
            <div style={{maxWidth: '800px', margin: '0 auto'}}>
              ...
              <details style={{marginBottom: '1rem', padding: '1rem', background: 'var(--ifm-background-color)', borderRadius: '8px'}}>
                <summary style={{cursor: 'pointer', fontWeight: 'bold', fontSize: '1.2rem'}}>
                  What certifications does Rediacc have?
                </summary>
                <p style={{marginTop: '1rem', lineHeight: '1.6'}}>
                  Rediacc maintains SOC 2 Type II certification, ISO 27001 certification, and complies with GDPR, 
                  HIPAA, PCI-DSS, and other major regulatory frameworks. Our compliance reports are available upon request.
                </p>
              </details>
              ...
              <details style={{marginBottom: '1rem', padding: '1rem', background: 'var(--ifm-background-color)', borderRadius: '8px'}}>
                ...
                <p style={{marginTop: '1rem', lineHeight: '1.6'}}>
                  ...
                  We provide full transparency with audit logs, compliance reports, and technical documentation to 
