...
function HomepageFeatures() {
  const features = [
    ...
    },
    {
      ...
      description: 'Achieve up to 20:1 deduplication ratios (95% storage reduction) with our smart differential backup technology<sup>[1]</sup>.',
      link: '/features/backup',
    },
    {
      iconName: 'security',
      title: 'Advanced Security',
      description: 'Enterprise-grade security with encryption, MFA, and real-time threat detection.',
      link: '/features/security',
    },
    {
      iconName: 'scaling',
      title: 'Auto-Scaling',
      description: 'Seamlessly scale your infrastructure up or down based on demand.',
      link: '/features/scaling',
    },
    {
      iconName: 'disaster-recovery',
      title: 'Disaster Recovery',
      description: 'Instant recovery to any point in time with zero data loss.',
